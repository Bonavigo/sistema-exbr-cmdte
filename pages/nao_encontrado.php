...
<head>
	<meta charset="utf-8">
	<title>Página não encontrada - Exército Brasileiro do Habbo</title>
...
<body class="bg-tom height_100vh d-flex justify-content-center align-items-center text-white container">
	<div>
		<h3><b>Ops, parece que o senhor Anônimo se perdeu no nosso servidor e não conseguiu achar a página que você estava procurando.</b></h3>
